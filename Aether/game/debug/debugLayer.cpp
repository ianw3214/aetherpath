...
void DrawCollision(float x, float y, const Shape& shape)
{
    ...
    {
        x = CameraService::RawToScreenX(x + shape.m_offsetX);
        y = CameraService::RawToScreenY(y + shape.m_offsetY);
    ...
    {
        float last_x = CameraService::RawToScreenX(x + shape.m_offsetX + shape.m_radius);
        float last_y = CameraService::RawToScreenY(y + shape.m_offsetY);
